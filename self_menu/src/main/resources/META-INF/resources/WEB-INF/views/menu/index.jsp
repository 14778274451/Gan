...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/gan/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/gan/menu/js/jquery.js"></script>
<script type="text/javascript" src="/gan/menu/js/vue.js"></script>
<script type="text/javascript" src="/gan/menu/js/menu.js"></script>
